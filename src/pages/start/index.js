...
const Start = () => {
  ...
  console.log({ sliderValue, questionOne, questionTwo, questionTree, questionFour });
  return (
    <div class="full-page-start">
      <div class="full-content-slider" style={{ marginTop: 20 }} >
        <div class="checkbox-div-title"><p>Qual valor deseja investir em Marketing Digital?</p></div>
        <div style={{ width: "75%", marginBottom: 20 }}>
          <SliderCustomMarks
            ...
            min={39990}
            max={129990}
            valueLabelFormat={x => `${x.toString().replace(/^(\d*)(\d{2})$/g, "R$ $1,$2")}`}
            value={sliderValue}
      ...
      <div class="full-page-start">
        <div class="full-content-slider">
          <div class="checkbox-div" style={{ paddingBottom: "20px" }}>
            <div class="checkbox-div-title" >
              <p>Deseja a criação ou modificação de uma Logo para a sua Marca?</p>
            </div>
            <RadioGroup row aria-label='controlled' name='controlled' value={questionOne} onChange={handleChangeOne}>
        ...
        <div class="full-content-slider">
          <div class="checkbox-div" style={{ paddingBottom: "20px" }}>
            <div class="checkbox-div-title">
              <p>Deseja a criação ou otimização de Redes Sociais para sua Empresa?</p>
            </div>
            <RadioGroup row aria-label='controlled' name='controlled' value={questionTwo} onChange={handleChangeTwo}>
              <FormControlLabel value={true} control={<Radio />} label='Sim' />
              <FormControlLabel value={false} control={<Radio />} label='Não' />
            </RadioGroup>
          </div>
        ...
        <div class="full-content-slider">
          <div class="checkbox-div" style={{ paddingBottom: "20px" }}>
            ...
            <RadioGroup row aria-label='controlled' name='controlled' value={questionTree} onChange={handleChangeTree}>
              <FormControlLabel value={true} control={<Radio />} label='Sim' />
              <FormControlLabel value={false} control={<Radio />} label='Não' />
            </RadioGroup>
          </div >
        ...
        <div class="full-content-slider">
          <div class="checkbox-div" style={{ paddingBottom: "20px" }}>
            <div class="checkbox-div-title">
              <p>Tem interesse de conteúdo ou artes para postagem no seu Blog ou LinkedIn?</p>
            </div>
            <RadioGroup row aria-label='controlled' name='controlled' value={questionFour} onChange={handleChangeFour}>
              <FormControlLabel value={true} control={<Radio />} label='Sim' />
              <FormControlLabel value={false} control={<Radio />} label='Não' />
            </RadioGroup>
          </div>
