      ...
      {userNavMenuBranding ? (
        ...
        <StyledLink href='/'>
          {navCollapsed && !navHover ?
            <img src='/mark/logos/mark-logo-square.png' style={{ width: "auto", height: "50px", margin: "15px 0" }}></img>
            :
            < img src='/mark/logos/mark-logo-horizontal.png' style={{ width: "auto", height: "60px", margin: "30px 0" }}></img>
          }
